package be.kdg.prog6.thebakery.factory.architecture;
...
public class ArchitectureTest {
    private static final String DOMAIN_LAYER = "be.kdg.prog6.thebakery.factory.domain..";

    private static final String ADAPTER_LAYER = "be.kdg.prog6.thebakery.factory.adapters..";
    private static final String CORE_LAYER = "be.kdg.prog6.thebakery.factory.core..";
    private static final String PORT_LAYER = "be.kdg.prog6.thebakery.factory.ports..";
    ...
    void givenApplicationClasses_thenNoLayerViolationsShouldExist() {
        ...
        JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prog6.thebakery.factory");
