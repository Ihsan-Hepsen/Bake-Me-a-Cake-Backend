package be.kdg.prog6.thebakery.warehouse.architecture;
...
public class ArchitectureTest {
    private static final String DOMAIN_LAYER = "be.kdg.prog6.thebakery.warehouse.domain..";

    private static final String ADAPTER_LAYER = "be.kdg.prog6.thebakery.warehouse.adapters..";
    private static final String CORE_LAYER = "be.kdg.prog6.thebakery.warehouse.core..";
    private static final String PORT_LAYER = "be.kdg.prog6.thebakery.warehouse.ports..";
    ...
    void givenApplicationClasses_thenNoLayerViolationsShouldExist() {
        ...
        JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prog6.thebakery.warehouse");
